<template>
  <div class="index">
    ...
    <div class="weather_forecast">
      ...
      <swiper :options="swiperOption" ref="mySwiper" @someSwiperEvent="callback" class="forecast_list">
        <!-- slides -->
        <swiper-slide class="weather_details" v-for="(item,index) in forecastWeather" :key="index">
          <h3 class="day">今天</h3>
